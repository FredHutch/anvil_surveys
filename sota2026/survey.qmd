...
Thank you for participating in the State of the AnVIL 2025 Community Poll! The AnVIL is the NHGRI Genomic Data Science Analysis, Visualization, and Informatics Lab-space which provides a unified environment for secure data management and computation. This allows for cloud-based analysis of large datasets without having to move those datasets. The objective of this poll is to understand user experience, needs, and any potential barriers to adoption for the AnVIL platform. This will be achieved by collecting quantitative data on usage, experiences, and preferences. We estimate this poll will take between 10 and 15 minutes to complete. Your feedback will help us as we continue developing this platform to support your research and data storage needs.
...
sd_question(#mc_multiple instead?
  type   = 'mc',
...
#add a question asking if they use GTEx data?
...
sd_question(
  ...
  label = 'What AnVIL resources would make your learning easier or more relevant?'
)
...
sd_question(
    type = 'textarea',
    id   = 'training_wanted',
    label = 'Please share any additional training resources or topics you would like to see.'
)
...
sd_question(
  ...
  label = 'Overall, what is the most important thing you think the AnVIL team should focus on?'
)
