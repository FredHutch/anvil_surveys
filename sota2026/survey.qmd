...
sd_question(
  type   = 'mc',
  id     = 'use_data_dict',
  label  = 'Have you submitted a data dictionary to the AnVIL [following this process](https://anvilproject.org/learn/data-submitters/submission-guide/set-up-a-data-model)?',
  option = yes_no_unsure_options
)
