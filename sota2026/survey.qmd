...
[AnVIL](https://anvilproject.org/) (the NHGRI Genomic Data Science Analysis, Visualization, and Informatics Lab-space) is a unified environment for secure data management and computing. It enables cloud-based analysis of large datasets directly in place, without the need to transfer that data elsewhere.
...
sd_question(
  type   = 'mc',
  id     = 'use_data_dict',
  label  = 'Have you submitted a data dictionary to the AnVIL [following the revised 09-2025 Data Model process](https://anvilproject.org/learn/data-submitters/submission-guide/set-up-a-data-model)?',
  option = yes_no_unsure_options
)
