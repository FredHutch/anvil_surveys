...
sd_question(
  type   = 'text',
  id     = 'role_other',
  label  = 'Please describe your career stage/position.'
)
...
sd_question(
  ...
  label  = 'Please describe your institutional affiliation.'
)
...
sd_question(
  ...
  option = c(
    'I currently use AnVIL for my work/research.' = 'aware_current', #send to page 3
...
sd_question(
  type   = 'mc_multiple',
  id     = 'why_external',
  label  = 'Which external factors apply to your use of AnVIL? (select all that apply)',
  option = c(
...
sd_question(
  ...
  label  = 'Please describe your reason for using AnVIL.'
)
...
sd_question(
  type   = 'mc_buttons',
  id     = 'rec_likelihood',
  label  = 'How likely are you to recommend AnVIL to a colleague?',
  option = c(
    "1<br>Not at all<br>likely" = 1,
    "&emsp;&emsp;2&emsp;&emsp;" = 2,
    "&emsp;&emsp;3&emsp;&emsp;" = 3,
    "&emsp;&emsp;4&emsp;&emsp;" = 4, 
    "5<br>Extremely<br>likely" = 5
  )
)
