...
sd_question(
  ...
  label = '(Optional) Provide further detail concerning what factored into your response above.'
)
...
sd_question(
  type   = 'mc',
  id     = 'use_data_dict',
  label  = 'Have you utilized the new data dictionary while submitting clinical data?',
  option = yes_no_unsure_options
)
...
sd_question(
  ...
  label  = '(Optional) What did you think of your experience with the data dictionary while submitting clinical data?'
)
